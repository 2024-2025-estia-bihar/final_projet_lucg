...
class RealTemperature(Base):
    ...
    __table_args__ = (
        UniqueConstraint('timestamp', 'latitude', 'longitude', name='unique_timestamp_latitude_longitude'),
    )
...
class Prediction(Base):
    ...
    __table_args__ = (
        UniqueConstraint('timestamp', 'latitude', 'longitude', 'model_id', name='unique_timestamp_latitude_longitude_model_id'),
    )